...
public class FragmentNow extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.now_fragment,container,false);


        recyclerView = (RecyclerView) v.findViewById(R.id.recyclerViewNow);
    ...
    private List<Movie> getMovies(int page) {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                Constants.NOW_PLAYING_URL+page,null, new Response.Listener<JSONObject>() {
            @Override
