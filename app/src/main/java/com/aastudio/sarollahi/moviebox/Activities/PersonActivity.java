...
public class PersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nativeBannerAd = new NativeBannerAd(this, Constants.BIO_ZONE_ID);
    ...
    private void inflateAd(NativeBannerAd nativeBannerAd) {
        ...
        AdOptionsView adOptionsView = new AdOptionsView(PersonActivity.this, nativeBannerAd, nativeAdLayout);
