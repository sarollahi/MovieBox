...
public class FavoriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nativeBannerAd = new NativeBannerAd(this, Constants.Favorite_ZONE_ID);
    ...
    private void inflateAd(NativeBannerAd nativeBannerAd) {
        ...
        AdOptionsView adOptionsView = new AdOptionsView(FavoriteActivity.this, nativeBannerAd, nativeAdLayout);
